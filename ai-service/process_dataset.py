...
try:
    from app.services.data_processor import QuickDrawDataProcessor
    from app.services.data_loader import CATEGORIES
...
def main():
    ...
    if args.list:
        ...
        from app.services.data_loader import QuickDrawDataLoader
